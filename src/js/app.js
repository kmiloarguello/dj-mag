...
(0, _jquery2.default)(function () {
  var $tvShowsContainer = (0, _jquery2.default)('#app-body').find('.main-djs');
  //Evento al hacer click
  $tvShowsContainer.on('click', 'i.em-maple_leaf', function (ev) {
    var $this = (0, _jquery2.default)(this); //boton en el que se hizo click
  ...
  var template = '<article class="djs">' + '<div class="left img-container">' + '<img src=":img:" alt=":img alt:">' + '</div>' + '<div class="right info">' + '<h1>:name:</h1>' + '<p>:summary:</p>' + '<i class="em em-maple_leaf"></i>' + '</div>' + '</article>';
